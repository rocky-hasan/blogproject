...
class ContactForm(forms.ModelForm):
    class Meta:
        model = Contact
        fields = ['username', 'email', 'address', 'message']
        labels = {
            'username': 'Name', 'email': 'Email', 'address': 'Address', 'message': 'Message'
        }
        widgets = {
            'username': forms.TextInput(attrs={'class': 'form-control', 'class': 'form-group'}),
